...
namespace Be.Stateless.BizTalk.Xml.Xsl
{
	...
	<xsl:import href='map://type/Be.Stateless.BizTalk.Xml.Xsl.CompoundContextMapTransform, Be.Stateless.BizTalk.Common.Tests, Version=2.0.0.0, Culture=neutral, PublicKeyToken=3707daa0b119fc14' />
